...
Will do all these. Code review **requires some thought**. Who can / should / best to do it? Technical planning can base on https://pythonhealthdatascience.github.io/des_rap_book/pages/guide/sharing/peer_review.html
...
This **requires some thought** - compare to m/m/s queue possible for most basic model - could also compare to regression but is that validation rather than mathematical?
