...
* Add code to check assumption: travel to hospital varies by response category.
* Then would require on real data:
    * Assess whether travel to hospital varies by response category.
...
* Add code to check assumption: handover time varies by response category.
* Then would require on real data:
    * Assess whether handover time varies by response category.
...
* Add code to check assumption: wrap-up time varies by response category.
* Then would require on real data:
    * Assess whether wrap-up time varies by response category.
