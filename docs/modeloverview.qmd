...
The proposed approach begins with a simple prototype and builds up in stages. Each stage aligns with specific use case proposed by the ambulance service. 
...
We will use a warm-up period. We anticipate maybe a one year run time. We will run replications (more intuitive than long run).
