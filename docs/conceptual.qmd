...
| Call category | Separate arrival times - part of arrival distribution or assigned after | Arrival times above should also be by category OR have another distribution with probabilities to assign them |
...
* Just people conveyed to hospital, or include hear-and-treat and see-and-treat? As then, its either, just those parameters for see-and-convey, or just for whole thing
    * If excluded, does it bias utilisation estimates? Or is that a reasonable simplification?
* Any existing analysis looking at trends in call arrivals? Want to understand what the hour / day of week variation is.
