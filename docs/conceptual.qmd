...
It may be possible though to estimate a SD from the provided mean/median/IQR, allowing use of a lognormal distributions.
...
No relevant data was identified to estimate travel speed, so an arbirtrary speed of 45mph was chosen. Based on this, the average travel time to hospital would be:
