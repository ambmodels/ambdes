...
* Use **conda/mamba** for environment management, as it is familiar.
...
* What is preferred for environment management? Would uv be ok?
...
* How does this sound? What is sensitivity of aggregate parameters?
...
class CategoryArrivals:
    """Arrivals by response category."""

    data: pd.DataFrame


@dataclass(frozen=True)
class DailyCategoryArrivals:
    """Arrivals by response category and day of week."""

    data: pd.DataFrame


@dataclass(frozen=True)
class CountyDailyCategoryArrivals:
    """Arrivals by response category, day of week and county."""

    data: pd.DataFrame


# These can all be referred to as "Arrivals" type
Arrivals: TypeAlias = (
    CategoryArrivals
    | DailyCategoryArrivals
    | CountyDailyCategoryArrivals
)
```
